<!-- VERBATIM copy of the OFFICIAL sd25-pe skill, fetched 2026-08-09 via
     npx --yes skills@latest add https://arkdocs-en.tos-ap-southeast-1.volces.com/skills/ --skill sd25-pe
     This is the authoritative Seedance 2.5 prompt-engineering contract. 941 lines, complete.
     Companion docs: video-seedance-2.5-prompt-guide.md (the public doc page),
     video-seedance-2.5.md (the API spec). Do not conflate the three. -->
