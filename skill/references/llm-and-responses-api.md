...
<!-- TODO: verify — this update (and a prior update attempt) cited a batch of ModelArk doc pages (including 1396491, 1398933, 1449737, 1568221, 1585128, 1602228, 1827534, 1956279, 1958520, 1958521, 1958523, 1958524, 2123215, 2553718) as changed sources, but every one of them resolved only to an unrelated promotional banner ("Official Dreamina Seedance 2.5 API is now live") with no retrievable LLM/Responses-API content. No factual claims in this file could be grounded against these sources, so the sections below are left unchanged pending a retrieval that actually surfaces the underlying documentation text. -->
